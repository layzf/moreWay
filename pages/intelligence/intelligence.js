...
Page({
  ...
  data: {
    ...
    swiper_1: [
      { url: 'http://img.duorang.com/upload/img/ck_1.jpg',txt:'所有商家已签署商家承诺函，并缴纳诚信保障金',title:'商家承诺函' },
      { url: 'http://img.duorang.com/upload/img/ck_2.jpg',txt:'商家的身份信息、经营资质、品牌授权资格认证建档',title:'商家信息备案'  },
      { url: 'http://img.duorang.com/upload/img/ck_3.jpg',txt:'集采现场可要求商家出示多让签字盖章的价格文件',title:'集采价格表'  },
    ],
    newswiper_1:[],
    box:[
      { url: 'http://img.duorang.com/upload/img/list_1.png', name: "社群需求收集"},
      { url: 'http://img.duorang.com/upload/img/list_2.png', name: "买手市场考察" },
      { url: 'http://img.duorang.com/upload/img/list_3.png', name: "商家甄选" },
      { url: 'http://img.duorang.com/upload/img/list_4.png', name: "协议签署" },
      { url: 'http://img.duorang.com/upload/img/list_5.png', name: "对比价格" },
      { url: 'http://img.duorang.com/upload/img/list_6.png', name: "审核资质"},
      { url: 'http://img.duorang.com/upload/img/list_7.png', name: "正式开团" },
      { url: 'http://img.duorang.com/upload/img/list_8.png', name: "业主参团" },
      { url: 'http://img.duorang.com/upload/img/list_9.png', name: "无忧下单"},
    ],
    shareHome:false,
    height:0,
    userId:''
...
//口碑介绍 轮播
  ...
  onLoad: function (options) {
    ...
    if(options.shareType == 1){
      this.setData({shareHome:true,height:h});
    }
    this.setData({newswiper_1: this.data.newswiper_1})
